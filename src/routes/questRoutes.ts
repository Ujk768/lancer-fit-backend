...
import { listQuests, removeQuest, getDailyQuests, setDailyQuests, clearDailyOverride, addQuest,claimQuestPoints } from "../controllers/questController";
...
router.post("/:id/claim",authenticate,claimQuestPoints)
